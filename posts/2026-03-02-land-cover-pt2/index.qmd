...
![Current WRSI of East Africa from USGS FEWSNET, November 21-30, 2025](images/wsel202533do.png){width="50%" height="auto" fig-alt="East Africa WRSI from USGS FEWSNET, November 21-30, 2025"}
...
![Screenshot of Global Agricultural Monitoring web interface](images/glams_interface.png){width="100%" height="auto" fig-alt=Screenshot: Global Agricultural Monitoring web UI"}
...
![Screenshot of Copernicus Browser](images/copernicus_browser.png){width="100%" height="auto" fig-alt="Screenshot: Copernicus Browser"}
