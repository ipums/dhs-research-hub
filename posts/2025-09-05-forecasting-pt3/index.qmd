...
image-alt: "Climate scenario chart"
categories:
  - Climate
  - Scenarios
  - Temperature
...
::: colum-body.outset
![](images/clipboard-1796866763.png){fig-alt="SSPs and mitigation and adaptation challenges"}
...
# The Coupled Model Intercomparison Project Phase 6 (CMIP-6)
...
::: callout-note
Here are the Tmax files for 2030 for [2-4.5](https://data.chc.ucsb.edu/products/CHC_CMIP6/2030_SSP245/Tmax/) and [5-8.5](https://data.chc.ucsb.edu/products/CHC_CMIP6/2030_SSP585/Tmax/). Here are the Tmax files for 2050 for [2-4.5](https://data.chc.ucsb.edu/products/CHC_CMIP6/2050_SSP245/Tmax/) and [5-8.5](https://data.chc.ucsb.edu/products/CHC_CMIP6/2050_SSP585/Tmax/2016/). **Note**: *both the projections for 2030 and 2050 come from the files labeled for the year of 2016. As we mentioned earlier, the projection data is calculated by adding a daily delta to each observation.*
:::
...
#| code-fold: true
#| fig-align: center
#| fig-alt: "Scenario temperature data by DHS cluster, 2030 and 2050"
...
#| code-fold: true 
#| fig-align: center
#| fig-alt: "Average temperature over  time by SSP in DHS cluster #5"
...
#| code-fold: true 
#| fig-align: center
#| fig-alt: "Projected Tmax by DHS Cluster in Kenya January 2030, SSP 2-4.5, SSP 5-8.5"
library(ggspatial)
...
#| code-fold: true
#| fig-align: center
#| fig-alt: "Projected Tmax by DHS Cluster in Kenya January 2050, SSP 2-4.5, SSP 5-8.5"
