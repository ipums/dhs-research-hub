...
image-alt: "Subseasonal NDVI max"
...
These effects are especially pronounced in low-income countries where
extreme weather may have an outsize impact. Beyond merely the choices of
when to plant, water, and harvest, research consistently demonstrates
that growing conditions—and by extension, food access and
availability—play a key role in migration decisions, livelihood
selection and diversification, health outcomes, resource related
conflict, and the choice of whether, when and how often to have
children. Because of this, data on immediate and longitudinal growing
conditions are at the heart of scientists' understanding of the link
between weather extremes and health, particularly among the most
vulnerable and poorest regions and populations.
...
selected PMA
samples[@brooks2023investigating]](images/max_ndvi.png){width="100%" fig-alt="NDVI max"}
:::
...
NDVI provides an invaluable tool for understanding how extreme weather
