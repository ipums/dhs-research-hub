...
image-alt: "QGIS for Spatial Data Analysis"
open-graph:
  title: "Using QGIS for Spatial Data Analysis"
  description: |
    Standalone GIS software can provide an interactive alternative to code-based
...
::: column-margin
[![](images/qgis.png){fig-alt="QGIS logo"}](https://www.qgis.org/)
:::
...
::: column-page
![An overview of the QGIS interface](images/Fig2.png){#fig-2 fig-alt="GQIS UI: screenshot"}
:::
...
loaded](images/Fig3.png){#fig-3 fig-alt="QGIS UI: initial data layers"}
:::
...
::: column-page-inset
![Data layers after symbology adjustments](images/Fig4.png){#fig-4 fig-alt="QGIS UI: after symbology adjustments"}
:::
...
::: column-page-inset
![Raster Calculator window](images/Fig5.png){#fig-5 fig-alt="QGIS UI: Raster Calculator"}
:::
...
::: column-page-inset
![Clip Raster window](images/Fig7.png){#fig-7 fig-alt="QGIS UI: Clip Raster"}
:::
...
symbology](images/Fig8.png){#fig-8 fig-alt="QGIS UI: raster clip results"}
:::
...
::: column-page-inset
![Spatial buffer window](images/Fig9.png){#fig-9 fig-alt="QGIS UI: spatial buffer window"}
:::
...
output](images/Fig10.png){#fig-10 fig-align="center" fig-alt="QGIS UI: Using the Magnifier tool"}
...
![Zonal Statistics window](images/Fig11.png){#fig-11 fig-align="center" fig-alt="QGIS UI: Zonal Statistics"}
...
::: column-page-inset
![](images/Fig12.png){#fig-12 fig-alt="QGIS UI: Mean Tmax buffer"}
:::
