...
![Figure 1. Map depicting accessibility model inputs](images/Input_Data_Map.png){fig-alt="Health care facilities and population centers showing density of population."}
...
![Figure 2. Map depicting simple distance from facilities](images/Simple_Distance_Map.png){fig-alt="Simple metric model: map depicting health care facilities and population centers."}
...
![Figure 3. Map depicting a gravity model to measure distance from facilities](images/Gravity_Model_Map.png){fig-alt="Gravity model: map depicting health care facilities and population centers."}
...
![Figure 4. Map depicting a gravity model to measure distance from facilities](images/2SFCA_Model_Map.png){fig-alt="2SFCA model: map depicting health care facilities and population centers."}
