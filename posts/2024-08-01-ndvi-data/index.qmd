...
open-graph:
  title: |
    IPUMS DHS Research Hub — An Iterative Workflow for Loading NDVI Data in R
  description: |
...
::: column-margin
While this resolution exceeds our typical needs, we use 250 meter data for
this post and the next to help demonstrate some of the relevant considerations
for working with NDVI data in a population health context.
:::
