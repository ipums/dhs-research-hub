...
description: |
    We use data from two climates to illustrate approaches to 
...
open-graph:
  title: "IPUMS DHS Research Hub — Aggregation Methods for NDVI Data"
  description: |
    We use data from two distinct climates to illustrate approaches to 
    processing NDVI data
  image: index_files/figure-html/listing-img-1.png
twitter-card:
  title: "IPUMS DHS Research Hub — Aggregation Methods for NDVI Data"
...
them to explore how climate and seasonality may play a role in the way
we aggregate NDVI data.
...
from other climate metrics, like precipitation and temperature.
...
values over the course of many years. In climate science, these long-run
comparisons are called **normals**.
