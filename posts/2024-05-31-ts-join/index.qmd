...
image-alt: "Heatwave model coefficients"
open-graph:
  title: |
...
::: column-margin
`r hex("tidyr", alt = "Hex logo for the tidyr R package")`
:::
...
::: column-margin
`r hex("gtsummary", alt = "Hex logo for the gtsummary R package")`
:::
...
Show table code
</summary><div class="code-copy-outer-scaffold">
<div class="code-copy-outer-scaffold"><div id="cb38" class="sourceCode">
<pre class="downlit sourceCode r code-with-copy"><code class="sourceCode R"><span><span class="kw"><a href="https://rdrr.io/r/base/library.html">library</a></span><span class="op">(</span><span class="va"><a href="https://github.com/ddsjoberg/gtsummary">gtsummary</a></span><span class="op">)</span></span>
<span></span>
<span><span class="fu"><a href="https://www.danieldsjoberg.com/gtsummary/reference/tbl_regression.html">tbl_regression</a></span><span class="op">(</span></span>
<span>  <span class="va">heatwave_mod</span>, </span>
...
<span>    MEANPROPHEATWAVE <span class="op">=</span> <span class="st">"Mean proportion of days in heatwave"</span>,</span>
<span>    TRIMESTER <span class="op">=</span> <span class="st">"Trimester"</span>,</span>
<span>    BIDX <span class="op">=</span> <span class="st">"Birth order"</span>,</span>
<span>    EDUCLVL <span class="op">=</span> <span class="st">"Education level"</span>,</span>
<span>    BIRTHWTREF <span class="op">=</span> <span class="st">"Birth weight source"</span>,</span>
<span>    HEIGHTFEM <span class="op">=</span> <span class="st">"Mother's height (cm)"</span>,</span>
<span>    `DHSID.sd__(Intercept)` <span class="op">=</span> <span class="st">"Random effects: Enumeration cluster (SD)"</span>,</span>
<span>    `Residual.sd__Observation` <span class="op">=</span> <span class="st">"Random effects: Residual (SD)"</span></span>
<span>  <span class="op">)</span></span>
<span><span class="op">)</span> <span class="op">|&gt;</span> </span>
<span>  <span class="fu"><a href="https://www.danieldsjoberg.com/gtsummary/reference/bold_italicize_labels_levels.html">italicize_labels</a></span><span class="op">(</span><span class="op">)</span> <span class="op">|&gt;</span> </span>
<span>  <span class="fu"><a href="https://www.danieldsjoberg.com/gtsummary/reference/modify.html">modify_header</a></span><span class="op">(</span>update <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/base/list.html">list</a></span><span class="op">(</span>label <span class="op">=</span> <span class="st">"Covariate"</span><span class="op">)</span><span class="op">)</span> <span class="op">|&gt;</span> </span>
...
<span>    <span class="fu">gt</span><span class="fu">::</span><span class="fu"><a href="https://gt.rstudio.com/reference/md.html">md</a></span><span class="op">(</span><span class="st">"# Effects of Heatwave Days on Birthweight"</span><span class="op">)</span></span>
<span>  <span class="op">)</span></span>
<span><span class="co">#&gt; Warning: The `update` argument of `modify_header()` is deprecated as of gtsummary 2.0.0.</span></span>
<span><span class="co">#&gt; ℹ Use `modify_header(...)` input instead. Dynamic dots allow for syntax like</span></span>
<span><span class="co">#&gt;   `modify_header(!!!list(...))`.</span></span>
<span><span class="co">#&gt; ℹ The deprecated feature was likely used in the gtsummary package.</span></span>
<span><span class="co">#&gt;   Please report the issue at &lt;https://github.com/ddsjoberg/gtsummary/issues&gt;.</span></span></code></pre>
...
<div id="wudqrhqljr" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#wudqrhqljr table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#wudqrhqljr thead, #wudqrhqljr tbody, #wudqrhqljr tfoot, #wudqrhqljr tr, #wudqrhqljr td, #wudqrhqljr th {
  border-style: none;
}
...
#wudqrhqljr .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#wudqrhqljr .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#wudqrhqljr .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#wudqrhqljr .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#wudqrhqljr .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#wudqrhqljr .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#wudqrhqljr .gt_spanner_row {
  border-bottom-style: hidden;
}

#wudqrhqljr .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wudqrhqljr .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#wudqrhqljr .gt_from_md > :first-child {
  margin-top: 0;
}

#wudqrhqljr .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#wudqrhqljr .gt_row_group_first td {
  border-top-width: 2px;
}

#wudqrhqljr .gt_row_group_first th {
  border-top-width: 2px;
}

#wudqrhqljr .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wudqrhqljr .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#wudqrhqljr .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#wudqrhqljr .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wudqrhqljr .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#wudqrhqljr .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wudqrhqljr .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#wudqrhqljr .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#wudqrhqljr .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#wudqrhqljr .gt_font_normal {
  font-weight: normal;
}

#wudqrhqljr .gt_font_bold {
  font-weight: bold;
}

#wudqrhqljr .gt_font_italic {
  font-style: italic;
}
...
#wudqrhqljr .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#wudqrhqljr .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#wudqrhqljr .gt_indent_1 {
  text-indent: 5px;
}

#wudqrhqljr .gt_indent_2 {
  text-indent: 10px;
}

#wudqrhqljr .gt_indent_3 {
  text-indent: 15px;
}

#wudqrhqljr .gt_indent_4 {
  text-indent: 20px;
}

#wudqrhqljr .gt_indent_5 {
  text-indent: 25px;
}

#wudqrhqljr .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#wudqrhqljr div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<td colspan="3" class="gt_heading gt_title gt_font_normal gt_bottom_border">

<caption id="effects-of-heatwave-days-on-birthweight">
Effects of Heatwave Days on Birthweight
</caption>
</td>
</tr>
<tr class="gt_col_headings even">
<th id="label" class="gt_col_heading gt_columns_bottom_border gt_left" data-quarto-table-cell-role="th" scope="col">
Covariate
</th>
...
<tr class="odd">
<td class="gt_row gt_left" headers="label" style="font-style: italic">
Mean proportion of days in heatwave
</td>
<td class="gt_row gt_center" headers="estimate">
-0.08
</td>
<td class="gt_row gt_center" headers="conf.low">
-0.22, 0.05
</td>
</tr>
<tr class="even">
...
<tr class="even">
<td class="gt_row gt_left" headers="label" style="font-style: italic">
Mean proportion of days in heatwave * Trimester
</td>
<td class="gt_row gt_center" headers="estimate">
<br>
</td>
...
<tr class="odd">
<td class="gt_row gt_left" headers="label">
&nbsp;&nbsp;&nbsp;&nbsp;Mean proportion of days in heatwave * 2
</td>
<td class="gt_row gt_center" headers="estimate">
0.22
</td>
...
<tr class="even">
<td class="gt_row gt_left" headers="label">
&nbsp;&nbsp;&nbsp;&nbsp;Mean proportion of days in heatwave * 3
</td>
<td class="gt_row gt_center" headers="estimate">
0.03
</td>
...
<tr class="odd">
<td class="gt_row gt_left" headers="label" style="font-style: italic">
Random effects: Enumeration cluster (SD)
</td>
<td class="gt_row gt_center" headers="estimate">
0.58
</td>
...
![](index_files/figure-html/listing-img-1.png){fig-alt="Heatwave model coefficients." .column-page width="100%"}
