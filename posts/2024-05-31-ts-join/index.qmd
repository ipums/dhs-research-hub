...
of `index = "months"` since we have multiple years of data. This
ensures that we don't aggregate months together across years.
...
::: callout-note
We're building this model primarily to demonstrate how you
might use aggregated survey and climate data. It's not intended to be be
a comprehensive modeling approach, and there are likely other variables
