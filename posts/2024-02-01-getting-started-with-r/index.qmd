...
::: column-margin
`r hex("Rlogo", alt = "R programming language logo")`
:::
...
::: column-margin
`r hex("ipumsr", alt = "Hex logo for the IPUMSR package")`
:::
...
::: column-margin
`r hex("tidyverse", alt = "Hex logo for the tidyverse collection of R packages")`
:::
...
::: column-margin
`r hex("sf", alt = "Hex logo for the sf R package for spatial vector data")`
:::
...
::: column-margin
`r hex("terra", alt = "Hex logo for the Terra R package for raster and vector spatial data")`
:::
