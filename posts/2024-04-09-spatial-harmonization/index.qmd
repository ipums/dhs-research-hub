...
open-graph:
  ...
  image-alt: "Households with improved sources of drinking water 1"
twitter-card:
  title: |
    Demystifying and Demonstrating Spatially 
    Harmonized Geography in IPUMS DHS
...
and 2013 data from Zambia.](images/sampleSpecific_all.png){fig-alt="Households with improved sources of drinking water 1"}
:::
...
Eastern.](images/zooms_SampleSpecific1.png){fig-alt="Households with improved sources of drinking water 2"}
...
consistent boundary.](images/zoom1_spatialHarm1.png){fig-alt="Households with improved sources of drinking water 3"}
:::
...
area.](images/zooms_SampleSpecific2.png){fig-alt="Households with improved sources of drinking water 4"}
...
a single spatially consistent unit.](images/zoom1_spatialHarm2.png){fig-alt="Households with improved sources of drinking water 5"}
:::
...
Malawi in 2016.](images/zooms_SampleSpecific3.png){fig-alt="Households with improved sources of drinking water 6"}
...
Mzimba and Mzuzu city are combined.](images/zoom1_spatialHarm3.png){fig-alt="Households with improved sources of drinking water 7"}
:::
...
Zimbabwe, 2011 data from Mozambique, and 2007 data from Zambia.<br>**Map
B** shows 2015 data from Tanzania and Zimbabwe, 2016 data from Malawi,
and 2013 data from Zambia.](images/spatiallyHarm_all.png){fig-alt="Households with improved sources of drinking water 8"}
:::
...
added” feature essential for sound research into change over time. See the
IPUMS DHS IPUMS-DHS Geography and GIS boundary files [page](https://www.idhsdata.org/idhs/gis.shtml) 
for more info on spatially harmonized geography.
