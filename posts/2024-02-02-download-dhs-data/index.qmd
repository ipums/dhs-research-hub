...
open-graph:
  title: "IPUMS DHS Research Hub — Obtaining Data from IPUMS DHS"
  description: |
    Identify and download data from the IPUMS DHS website and load it into R
...
The [ipumsr](https://tech.popdata.org/ipumsr/index.html) package
provides the tools you'll need to easily load your extract into R.
