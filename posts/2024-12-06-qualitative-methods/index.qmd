...
Understanding how climate and weather conditions impact people and
communities is complex. Moreover, we're not only interested in the
climate's *overall* impact on a population (for example, by identifying
where droughts or heat waves occur), but also in which *groups* of
people suffer disproportionately under these impacts. That is, when a
drought occurs in a given community, who within that community
experiences the most severe adverse outcomes?
...
# A person-centered understanding of climate impacts
...
climate impacts and suffering. However, we can refine our understanding
of vulnerability by also considering factors related to individual-level
exposure and resources that might shape resilience and recovery from a
disaster.[@Dorelien2023; @Pinchoff2021]
...
their livelihoods are to any environmental or climate related events.
...
response to climate or weather events.
...
people understand and experience climate change and weather events.
Considering first-hand accounts of flooding in a given community, for
example, provides insight into how flooding is measured, what resources
...
identify the key criteria for measuring climate impacts so they could more 
effectively find relevant survey data—for instance, from IPUMS DHS—that might
address the risk factors associated with those impacts. This, in turn, would
allow them to make more informed decisions when implementing climate change and
health interventions.

IPUMS DHS and climate data provide excellent
sources of data to quantify people’s experiences, but it is also
important to understand how climate change impacts people on the ground
based on their lived experiences. This is where qualitative
investigations can come in to support the development of appropriate and
place-based quantitative indicators capturing climate risks and
vulnerabilities.
...
describing climate impact and risk.

::: column-body-outset
![Climate risk is a product of individual, community, and macro-level
factors[@Reich2024]](images/flowchart.png){width="100%"}
:::
...
single definition for a climate disaster or event that is appropriate to
use across individuals, communities, and times. This blog and the data
provided through IPUMS provide excellent opportunities to create complex
linked climate-health data sets, but the development of place-based
indicators of risk comes from attention to the lived experiences of
